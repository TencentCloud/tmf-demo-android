...
public class StatusBarUtils {
    ...
    private static final int STATUSBAR_TYPE_ANDROID6 = 3; // Android 6.0
    private static final int STATUS_BAR_DEFAULT_HEIGHT_DP = 25; // 大部分状态栏都是25dp
    ...
    public static void translucent(Window window, @ColorInt int colorOn5x) {
        ...
        if (DeviceTypeUtils.isMeizu() || (DeviceTypeUtils.isMIUI() && Build.VERSION.SDK_INT < Build.VERSION_CODES.M)) {
...
//            }
    ...
    private static boolean supportTranslucent() {
        return Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT
                ...
                && !(DeviceTypeUtils.isEssentialPhone() && Build.VERSION.SDK_INT < 26);
    }
    ...
    private static boolean isMIUICustomStatusBarLightModeImpl() {
        if (DeviceTypeUtils.isMIUIV9() && Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            return true;
        }
        return DeviceTypeUtils.isMIUIV5() || DeviceTypeUtils.isMIUIV6()
                || DeviceTypeUtils.isMIUIV7() || DeviceTypeUtils.isMIUIV8();
    }
    ...
    public static boolean supportTransclentStatusBar6() {
        return !(DeviceTypeUtils.isZUKZ1() || DeviceTypeUtils.isZTKC2016());
    }
    ...
    private static void initStatusBarHeight(Context context) {
        ...
        if (DeviceTypeUtils.isTablet(context)
