...
public class DeviceTypeUtils {
    ...
    private static final String BRAND = PrivacyFitUtil.BRAND;
    ...
    static {
        ...
        try {
            ...
            if (BuildConfig.DEBUG) {
                Log.w(TAG, "read SystemProperties error", e);
            }
        }
    }
    ...
    public static boolean isZUKZ1() {
        if (MODEL == null) {
            MODEL = PrivacyFitUtil.MODEL;
        }
        final String board = MODEL;
    ...
    private static boolean isPhone(String[] boards) {
        final String board = PrivacyFitUtil.BOARD;
        if (board == null) {
            return false;
        }
