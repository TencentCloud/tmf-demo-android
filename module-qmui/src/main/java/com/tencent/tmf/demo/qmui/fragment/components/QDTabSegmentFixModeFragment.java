                    ...
                    public void onClick(QMUIBottomSheet dialog, View itemView, int position, String tag) {
                        ...
                        switch (position) {
                            case 0:
                                ...
                                mTabSegment.addTab(tabBuilder.setText(getString(R.string.tabSegment_item_1_title))
                                        .build());
                                mTabSegment.addTab(tabBuilder.setText(getString(R.string.tabSegment_item_2_title))
                                        .build());
                                break;
                            case 1:
                                mTabSegment.reset();
                            ...
                            case 4: {
                                ...
                                QMUITab component = tabBuilder
                                        ...
                                        .setSelectedDrawable(ContextCompat
                                                .getDrawable(context, R.mipmap.icon_tabbar_component_selected))
                                        .setText("Components")
                                        .build();
...
//                                mTabSegment.showSignCountView(getContext(), 0, 20); // 也可以直接调用这个
                            ...
                            case 8:
                                mTabSegment.updateTabText(0, getStringById(R.string.qmui_item_35));
                                break;
                            case 9: {
                                QMUITab newTab = tabBuilder.setText(getStringById(R.string.qmui_item_36))
                                        .setNormalDrawable(
