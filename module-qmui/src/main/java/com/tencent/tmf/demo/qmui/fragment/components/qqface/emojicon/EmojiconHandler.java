...
package com.tencent.tmf.demo.qmui.fragment.components.qqface.emojicon;
...
public final class EmojiconHandler {
     ...
     * @param length
     */
    public static void addEmojis(Context context, SpannableStringBuilder text, int emojiSize, int textSize, int index,
            int length) {
     ...
     * @param useSystemDefault
     */
    public static SpannableStringBuilder addEmojis(Context context, SpannableStringBuilder text, int emojiSize,
