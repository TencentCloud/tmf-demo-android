...
public class QDPullRefreshFragment extends BaseFragment {
    ...
    protected View onCreateView() {
        ...
        QDDataManager qdDataManager = com.tencent.tmf.demo.qmui.manager.QDDataManager.getInstance();
    ...
    private void onDataLoaded() {
        List<String> data = new ArrayList<>(
                Arrays.asList("Helps", "Maintain", "Liver", "Health", "Function", "Supports", "Healthy", "Fat",
                        "Metabolism", "Nuturally", "Bracket", "Refrigerator", "Bathtub", "Wardrobe", "Comb", "Apron",
                        "Carpet", "Bolster", "Pillow", "Cushion"));
                ...
                .setOnSheetItemClickListener(new QMUIBottomSheet.BottomListSheetBuilder.OnSheetItemClickListener() {
                    ...
                    public void onClick(QMUIBottomSheet dialog, View itemView, int position, String tag) {
                        ...
                        switch (position) {
                            ...
                            case 2:
                                mPullRefreshLayout
                                        .setRefreshOffsetCalculator(new QMUICenterGravityRefreshOffsetCalculator());
                                break;
                            default:
                                break;
                        }
