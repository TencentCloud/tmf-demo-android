...
public class QDListWithDecorationSectionAdapter extends QDListSectionAdapter {
    ...
    protected QMUISectionDiffCallback<SectionHeader, SectionItem> createDiffCallback(
        ...
        return new QMUISectionDiffCallback<SectionHeader, SectionItem>(lastData, currentData) {
            ...
            @Override
            protected void onGenerateCustomIndexBeforeSectionList(IndexGenerationInfo generationInfo,
                    List<QMUISection<SectionHeader, SectionItem>> list) {
                generationInfo.appendWholeListCustomIndex(ITEM_INDEX_LIST_HEADER);
            }

            @Override
            protected void onGenerateCustomIndexAfterSectionList(IndexGenerationInfo generationInfo,
                    List<QMUISection<SectionHeader, SectionItem>> list) {
            ...
            @Override
            protected boolean areCustomContentsTheSame(@Nullable QMUISection<SectionHeader, SectionItem> oldSection,
                    int oldItemIndex, @Nullable QMUISection<SectionHeader, SectionItem> newSection, int newItemIndex) {
                return true;
            }
        };
    }
