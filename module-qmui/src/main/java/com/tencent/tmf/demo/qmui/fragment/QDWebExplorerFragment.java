...
import com.tencent.tmf.demo.qmui.view.QDWebView;
...
public class QDWebExplorerFragment extends BaseFragment {
    ...
    protected View onCreateView() {
        ...
        mTopBarLayout = view.findViewById(R.id.topbar);
    ...
    protected void initWebView() {
        ...
        containerLp.topMargin =
                needDispatchSafeAreaInset ? 0 : QMUIResHelper.getAttrDimen(getContext(), R.attr.qmui_topbar_height);
            ...
            public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimetype,
                ...
                if (needConfirm) {
                    ...
                    new QMUIDialog.MessageDialogBuilder(getContext())
                            .setMessage(R.string.qmui_item_61)
