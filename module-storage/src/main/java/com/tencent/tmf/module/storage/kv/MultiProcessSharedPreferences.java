...
public class MultiProcessSharedPreferences extends ContentProvider implements SharedPreferences {
    ...
    private static final String PERMISSION = "com.tencent.tmf.demo.permission.SP_NOTIFY_CHANGE";
    ...
    private void checkInitAuthority(Context context) {
        if (AUTHORITY_URI == null) {
            ...
            Uri authorityUri = MultiProcessSharedPreferences.AUTHORITY_URI;
...
//                        }
            ...
            MultiProcessSharedPreferences.AUTHORITY_URI = authorityUri;
        }
    }
        ...
        synchronized (this) {
            ...
            if (result != null && result) {
                ...
                if (mReceiver == null) {
                    ...
                    String action = makeAction(mName);
                    if (!TextUtils.isEmpty(action)) {
                        mContext.registerReceiver(mReceiver, new IntentFilter(action), PERMISSION, null);
                    }
                }
            }
        }
        ...
        switch (match) {
            ...
            case COMMIT:
                ...
                if (mListenersCount != null) {
                    Integer integer = mListenersCount.get(name);
